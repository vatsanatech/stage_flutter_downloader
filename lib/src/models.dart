...
class DownloadTask {
  ...
  /// Stable application content identifier, independent of signed URLs.
  final String? contentId;

  /// System-provided path to an offline HLS package.
  final String? localFilePath;

  @override
  String toString() =>
      'DownloadTask(taskId: $taskId, status: $status, progress: $progress, url: $url, filename: $filename, savedDir: $savedDir, timeCreated: $timeCreated, allowCellular: $allowCellular, contentId: $contentId, localFilePath: $localFilePath)';
